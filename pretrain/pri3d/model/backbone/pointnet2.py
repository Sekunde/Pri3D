...
from model.backbone.pointnet2_ops.pointnet2_modules import PointnetSAModuleVotes, PointnetFPModule
from model.backbone.pointnet2_ops.pointnet2_utils import furthest_point_sample
...
class PointNet2(nn.Module):
    ...
    def __init__(self, nclasses, pretrained=False):
        ...
        #self.fp4 = PointnetFPModule(mlp=[128,128,nclasses])
    ...
    def forward(self, pointcloud: torch.cuda.FloatTensor, end_points=None):
        ...
        #new_xyz1 = old_xyz[0,fps_inds[0].long(),:]
