...
class Cityscapes(data.Dataset):
    ...
    PATH = '/rhome/jhou/data/dataset/cityscape/'
    ...
    def __init__(
        ...
        self.annotations_base = os.path.join(self.PATH, "gtFine", phase)
        images_base = os.path.join(self.PATH, "leftImg8bit", phase)
        self.files = recursive_glob(rootdir=images_base, suffix=".png")
    ...
    def __getitem__(self, index):
        ...
        lbl = (lbl * 255.0).long()
        lbl = Cityscapes.map(lbl, self.LEARNING_MAP)
...
if __name__ == "__main__":
    ...
    augmentations = Compose([RandomRotate(10), RandomHorizontalFlip(0.5)])
